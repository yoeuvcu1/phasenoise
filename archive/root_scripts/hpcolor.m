...
[b,a] = butter(filter_order, normalized_fc, "high");
...
xlabel("Frekans (Hz)");
ylabel("PSD (dB/Hz)");
title("Beyaz ve yüksek geçiren colored noise karşılaştırması");
legend("White noise", "high-pass colored noise");
